              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Login untuk membuka akses</p>
                  </div>

                  <form class="row g-3 needs-validation" method="POST" action="proseslogin.php" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Belum Punya Akun? <a href="../register/">Buat Akun Sekarang</a></p>
                    </div>
                  </form>
